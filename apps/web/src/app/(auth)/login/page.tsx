...
export const metadata: Metadata = {
  title: 'Sign In',
  description: 'Sign in to CodePulse with your university Google account.',
};
        ...
        <div className="rounded-2xl bg-white/10 backdrop-blur-md ring-1 ring-white/20 p-8 shadow-2xl animate-fade-in">
          ...
          <div className="mb-8 flex flex-col items-center gap-3 text-center">
            <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-white/15 ring-1 ring-white/30">
              <svg className="h-7 w-7" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="2" y="20" width="6" height="18" rx="1" fill="white" fillOpacity="0.6"/>
                <rect x="11" y="12" width="6" height="26" rx="1" fill="white" fillOpacity="0.8"/>
                <rect x="20" y="6" width="6" height="32" rx="1" fill="white"/>
                <rect x="29" y="14" width="6" height="24" rx="1" fill="white" fillOpacity="0.7"/>
              </svg>
            </div>
            <div>
